/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maeestacivil_upd
--     es el encargado de realizar actualizaciones a la tabla maeestacivil
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maeestacivil_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maeestacivil_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maeestacivil
		SET cCodMaeEstaCivil = _cCodMaeEstaCivil, nvAbreviatura = _nvAbreviatura, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeEstaCivil = _cCodMaeEstaCivil;
