/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maeestapago_upd
--     es el encargado de realizar actualizaciones a la tabla maeestapago
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maeestapago_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maeestapago_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maeestapago
		SET cCodMaeEstaPago = _cCodMaeEstaPago, nvAbreviatura = _nvAbreviatura, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeEstaPago = _cCodMaeEstaPago;
