/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maeconcepto_upd
--     es el encargado de realizar actualizaciones a la tabla maeconcepto
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maeconcepto_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maeconcepto_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maeconcepto
		SET cCodMaeConcepto = _cCodMaeConcepto, cCodMaeTipoConcepto = _cCodMaeTipoConcepto, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvAbreviatura = _nvAbreviatura, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeConcepto = _cCodMaeConcepto;
