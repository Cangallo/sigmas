...
public class SeguridadApp {
    ...
    private final String passPhrase = "SIGMAS APP";
    ...
    SeguridadApp(SecretKey key, String algorithm) {
        try {
     ...
     * decrypter instances.
     */
    SeguridadApp(String passPhrase) {
    ...
    public String EncriptarApp(String secretString) {

        // Create encrypter/decrypter class
        SeguridadApp desEncrypter = new SeguridadApp(passPhrase);
        // Encrypt the string
        String desEncrypted = desEncrypter.encrypt(secretString);
        return desEncrypted;
    }

    public String DesencriptarApp(String desEncrypted) {
    ...
    public String NombreMaquina() {
        ...
        try {
            ...
            Logger.getLogger(SeguridadApp.class.getName()).log(Level.SEVERE, null, ex);
        }
        return hostname;
    }
