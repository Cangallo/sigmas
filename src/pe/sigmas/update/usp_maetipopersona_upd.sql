/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maetipopersona_upd
--     es el encargado de realizar actualizaciones a la tabla maetipopersona
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maetipopersona_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maetipopersona_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maetipopersona
		SET cCodMaeTipoPersona = _cCodMaeTipoPersona, nvAbreviatura = _nvAbreviatura, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeTipoPersona = _cCodMaeTipoPersona;
