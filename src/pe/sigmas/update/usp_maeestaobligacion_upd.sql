/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maeestaobligacion_upd
--     es el encargado de realizar actualizaciones a la tabla maeestaobligacion
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maeestaobligacion_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maeestaobligacion_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maeestaobligacion
		SET cCodMaeEstaObligacion = _cCodMaeEstaObligacion, nvAbreviatura = _nvAbreviatura, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeEstaObligacion = _cCodMaeEstaObligacion;
