/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_regrecibo_upd
--     es el encargado de realizar actualizaciones a la tabla regrecibo
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_regrecibo_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_regrecibo_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.regrecibo
		SET biIdRegRecibo = _biIdRegRecibo, iIdEjercicio = _iIdEjercicio, cCodRegContribuyente = _cCodRegContribuyente, iIdVencimiento = _iIdVencimiento, nvNumRecibo = _nvNumRecibo, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE biIdRegRecibo = _biIdRegRecibo;
