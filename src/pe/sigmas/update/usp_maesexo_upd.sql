/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maesexo_upd
--     es el encargado de realizar actualizaciones a la tabla maesexo
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maesexo_upd $$
CREATE PROCEDURE sisaguasaniamiento.usp_maesexo_upd(
 IN iOpSp int,
...
START TRANSACTION;
		...
		UPDATE sisaguasaniamiento.maesexo
		SET cCodMaeSexo = _cCodMaeSexo, nvAbreviatura = _nvAbreviatura, nvDenominacion = _nvDenominacion, nvDescripcion = _nvDescripcion, nvObservacion = _nvObservacion, iIdRegUsuaRegistra = _iIdRegUsuaRegistra, dtFechRegistra = _dtFechRegistra, iCantidadModifica = _iCantidadModifica, bEstado = _bEstado
		WHERE cCodMaeSexo = _cCodMaeSexo;
