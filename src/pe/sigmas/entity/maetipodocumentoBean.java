/*******************************************************************************
 * Descripcion       : Clase que contiene los atributos de maetipodocumento
 * Creado por        : APP
...
* @author APP
 */
    public class maetipodocumentoBean extends BaseBean
    {
        private String cCodMaeTipoDocumento; 
        ...
        public String getCCodMaeTipoDocumento (){
        return cCodMaeTipoDocumento ;
        }
        public void setCCodMaeTipoDocumento (String cCodMaeTipoDocumento){
        this.cCodMaeTipoDocumento=cCodMaeTipoDocumento ;
         }
