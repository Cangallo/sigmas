/*****************************************************************************************************************************
-- Este procedimiento almacenado usp_maeestacivil_ins
--     es el encargado de realizar inserciones a la tabla maeestacivil
--
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sisaguasaniamiento.usp_maeestacivil_ins $$
CREATE PROCEDURE sisaguasaniamiento.usp_maeestacivil_ins(
 IN iOpSp int,
...
/*SET @cCodMaeEstaCivil:=(SELECT  COALESCE(MAX(cCodMaeEstaCivil),0)+1 FROM sisaguasaniamiento.maeestacivil);*/

		INSERT INTO sisaguasaniamiento.maeestacivil (cCodMaeEstaCivil, nvAbreviatura, nvDenominacion, nvDescripcion, nvObservacion, iIdRegUsuaRegistra, dtFechRegistra, iCantidadModifica, bEstado)
		VALUES (_cCodMaeEstaCivil, _nvAbreviatura, _nvDenominacion, _nvDescripcion, _nvObservacion, _iIdRegUsuaRegistra, _dtFechRegistra, _iCantidadModifica, _bEstado);
